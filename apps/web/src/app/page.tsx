...
import { ArrowLeft, ArrowRight, BookCheck, Globe, GraduationCap } from 'lucide-react'
    ...
    <>
      ...
      <section className='card flex bg-base-200 items-center p-4 gap-4 justify-center my-10'>
        ...
        <div className='flex flex-col lg:block gap-4 text-lg text-justify lg:p-8'>
          <YouTubeVideo src='8b3Ea2o9JYA' className='card w-full lg:w-1/3 aspect-video float-left lg:mx-6 my-2' />
