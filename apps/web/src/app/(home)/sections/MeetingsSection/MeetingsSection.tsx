...
export const MeetingsSection = () => {
  return (
    <section className='card flex flex-col max-w-7xl mx-auto items-center py-4 gap-4 justify-center my-10'>
      ...
      <div className='carousel carousel-center w-[100%] space-x-2 pr-8 lg:pr-0 lg:w-2/3 px-4'>
        {Array(6).fill(0).map((_, i) => (
          <div key={i} id={`slide${i}`} className='card bg-base-100 h-[400px] lg:h-[500px] w-full carousel-item'>
            ...
            <div className='card-body'>
              <h2 className='card-title text-2xl'>Projeto Cegonha</h2>
              <p className='max-h-[100px] overflow-y-auto'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Perferendis earum suscipit libero nihil sunt pariatur, veritatis tempora? Eveniet fuga porro unde id quis aliquid itaque error veritatis quidem ipsum, quod sit ut reprehenderit odio qui voluptates libero sequi impedit minima, corrupti similique delectus voluptatibus repellendus quos! Suscipit ipsam excepturi eaque!</p>
            </div>
          </div>
        ))}
      </div>
